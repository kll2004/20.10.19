...
public class 배열1 {
	...
	public static void main(String[] args) {
		 ...
		 * 타입 배열이름[];
		 *  - 배열 선언 및 초기화
		 *  타입 [] 배열이름 = new타입[길이];//가장 많이 사용, 타입의 초기값으로 초기화
		 *  타입 [] 배열이름 = new타입[];{초기값1,초기값2.....초기값n};
		 *  타입 [] 배열이름 = [초기값1,초기값2.....초기값n]; new를 사용하지 않는 초기화는 반듯이 선언과 동시에 초기화 할때만 사용가능
		 *  -배열의 길이는 0이상이어야한다.
		 * 
		 * */
		int []arr1, arr2;//arr1 : 배열, arr2 : 배열
		int arr3[]={1,2,3,4,5};//arr3 : 배열, arr4 : 변수
		arr1 = new int[5];
		...
		System.out.println("배열 arr1의 2번째 값 : " +arr1[0]);
		System.out.println("배열 arr1의 3번째 값 : " +arr1[0]);
		System.out.println("배열 arr1의 4번째 값 : " +arr1[0]);
		System.out.println("배열 arr1의 5번째 값 : " +arr1[0]);
		...
		for(int i =0; i< arr6.length; i++) {
			System.out.println("배열 arr6의 "+(i+1)+"번쨰 값 : "+arr6[i]);
		}
