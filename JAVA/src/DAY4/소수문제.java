...
public class 소수문제 {
	...
	public static void main(String[] args) {
		 ...
		 * 반복횟수 : i는 1부터num까지 1씩 증가
		 * 규칙성 : i가num의 약수이면 약수의 갯수 cnt(count)를 1씩 증가
		 *  =>num를 i로 나누었을 때 나머지가 0과 같다면 cnt를 1증가
		 *  반복문 종료후 : cnt가 2이면 소수라고 출력하고, 아니면 소수가아님으로 출력
		 * */
