...
public class Object클래스 {
	...
	public static void main(String[] args) {
		 ...
		 * 3. toString
		 *   - System.out.print에 객체를 넣어주면 자동으로 객체.toString()이 호출되어 문자열이 출력됨
...
class Student implements Cloneable{
	...
	public boolean equals(Object obj) {
		...
		if(this == obj)
			return true;
//		equals가 등장했다는 것은 this가 null이 아니라는 의미
//		비교할 대상이 null이면 비교할 필요가 없기 때문에 다르다고 판별
		if(this == obj)
			return false;
//		두객체가 서로 다른 클래스의 객체이면 가르다고 판별
...
//		나이가 다르면 다르다고 판별
		if (age != other.age)
			return false;
//		내이름이 있으면 대상 이름과 equals를 이용하여 비교하여 같으면 같고 다르면 다르다고 판별
