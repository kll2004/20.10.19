...
//			배열을 늘려주고 복사하는 작업
	...
	public void deleteSubject(String subjuecTitle) {
		...
		for(int i = 0; i<subjectCount; i++) {
			if(subjuecTitle.equals(subjectList[i].getSubjectTitle())){
				index = i;
				break;
			}
		}
	...
	public String toString() {
		return "Student [이름=" + name + ", 주민번호=" + residentNum + ", 학번=" + studentNum + ", 학부="
				+ faculty + ", 전공=" + major + ", 전공=" + term + ", 수강과목=" + subjectCount + "]";
	}
}
